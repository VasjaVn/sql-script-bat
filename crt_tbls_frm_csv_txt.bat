...
rem psql -h %DB_HOST% -p %DB_PORT% -U %DB_USER% -d %DB_NAME% -a -f ./sql/feed_tbl/3_feed_tbl_component.sql 
rem psql -h %DB_HOST% -p %DB_PORT% -U %DB_USER% -d %DB_NAME% -a -f ./sql/feed_tbl/4_feed_tbl_component_version.sql
